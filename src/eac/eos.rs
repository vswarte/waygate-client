...
pub struct EOS_Connect_LoginCallbackInfo {
     ...
     */
    pub continuance_token: u64,
}

pub type EOS_Connect_OnLoginCallback =
    unsafe extern "C" fn(callback_info: *const EOS_Connect_LoginCallbackInfo);

#[repr(C)]
#[derive(Debug)]
pub struct EOS_AntiCheatCommon_OnClientAuthStatusChangedCallbackInfo {
    pub client_data: u64,

    pub client_handle: u64,

    pub client_auth_status: EOS_EAntiCheatCommonClientAuthStatus,
}

pub type EOS_AntiCheatClient_OnPeerAuthStatusChangedCallback = unsafe extern "C" fn(
    callback_info: *const EOS_AntiCheatCommon_OnClientAuthStatusChangedCallbackInfo,
);
...
#[allow(dead_code)]
const EOS_ANTICHEATCLIENT_REGISTERPEER_MIN_AUTHENTICATIONTIMEOUT: u32 = 40;
#[allow(dead_code)]
const EOS_ANTICHEATCLIENT_REGISTERPEER_MAX_AUTHENTICATIONTIMEOUT: u32 = 120;
#[allow(dead_code)]
const EOS_ANTICHEATCLIENT_REGISTERPEER_API_LATEST: i32 = 3;

#[repr(C)]
#[derive(Debug)]
pub struct EOS_AntiCheatClient_RegisterPeerOptions {
    /**
     ...
     */
    pub client_type: EOS_EAntiCheatCommonClientType,

    /**
     * Remote user's platform, if known
     */
    pub client_platform: EOS_EAntiCheatCommonClientPlatform,
